...
@user_router.get("/my-info", response_model=dict, description="Get my info")
...
@user_router.get("/{user_id}", response_model=dict, description="Get a user by user id")
...
@user_router.get("/", response_model=list[dict], description="Get all users")
...
@user_router.get("/search/username", response_model=list[dict], description="Search for users by username")
